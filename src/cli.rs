...
#[command(
    ...
    long_about = "hnm writes AGENTS.md, docs/{prd,adr,spec}, the feature-dev skill, and commit-time doc review hooks so AI agents follow the same harness as fengwu-bench."
)]
pub struct Cli {
    #[command(subcommand)]
